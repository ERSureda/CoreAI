...
public class DriverChannelController {
    ...
    public ResponseEntity<OfferResult> acceptOfferViaChannel(
        ...
        return ResponseEntity
                .status(200)
                .body(acceptOfferViaChannelUseCase.execute(mapper.toAcceptOfferViaChannelCommand(driverId, request)));
    }
    ...
    public ResponseEntity<OfferResult> rejectOfferViaChannel(
        ...
        return ResponseEntity
                .status(200)
                .body(rejectOfferViaChannelUseCase.execute(mapper.toRejectOfferViaChannelCommand(driverId, request)));
    }
    ...
    public ResponseEntity<DriverLocationResult> updateDriverLocation(
        ...
        return ResponseEntity
                .status(200)
                .body(updateDriverLocationUseCase.execute(mapper.toUpdateDriverLocationCommand(driverId, request)));
    }
}
