...
public record ListDriversHttpRequest(
        @Schema(description = "Tenant identifier to filter drivers.", example = "a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d")
        @NotNull(message = "TENANT-ID_REQUIRED")
        UUID tenantId,

        @Schema(description = "Optional administrative status filter.", example = "ACTIVE")
        String status,
