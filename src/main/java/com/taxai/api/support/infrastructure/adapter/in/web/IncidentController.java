...
public class IncidentController {
    ...
    public ResponseEntity<IncidentResult> createIncident(@Valid @RequestBody CreateIncidentHttpRequest request) {
        return ResponseEntity
                .status(201)
                .body(createIncidentUseCase.execute(mapper.toCreateIncidentCommand(request)));
    }
    ...
    public ResponseEntity<IncidentResult> getIncident(@PathVariable UUID id) {
        return ResponseEntity
                .status(200)
                .body(getIncidentUseCase.execute(mapper.toGetIncidentCommand(id)));
    }
    ...
    public ResponseEntity<ListIncidentsResult> listIncidents(@Valid ListIncidentsHttpRequest request) {
        return ResponseEntity
                .status(200)
                .body(listIncidentsUseCase.execute(mapper.toListIncidentsCommand(request)));
    }
    ...
    public ResponseEntity<IncidentResult> updateIncident(
        ...
        return ResponseEntity
                .status(200)
                .body(updateIncidentUseCase.execute(mapper.toUpdateIncidentCommand(id, request)));
    }
    ...
    public ResponseEntity<IncidentResult> assignIncident(
        ...
        return ResponseEntity
                .status(200)
                .body(assignIncidentUseCase.execute(mapper.toAssignIncidentCommand(id, request)));
    }
    ...
    public ResponseEntity<IncidentResult> resolveIncident(
        ...
        return ResponseEntity
                .status(200)
                .body(resolveIncidentUseCase.execute(mapper.toResolveIncidentCommand(id, request)));
    }
    ...
    public ResponseEntity<IncidentResult> closeIncident(@PathVariable UUID id) {
        return ResponseEntity
                .status(200)
                .body(closeIncidentUseCase.execute(mapper.toCloseIncidentCommand(id)));
    }
}
