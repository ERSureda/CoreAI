...
public class LostItemController {
    ...
    public ResponseEntity<LostItemResult> createLostItem(@Valid @RequestBody CreateLostItemHttpRequest request) {
        return ResponseEntity
                .status(201)
                .body(createLostItemUseCase.execute(mapper.toCreateLostItemCommand(request)));
    }
    ...
    public ResponseEntity<LostItemResult> getLostItem(@PathVariable UUID id) {
        return ResponseEntity
                .status(200)
                .body(getLostItemUseCase.execute(mapper.toGetLostItemCommand(id)));
    }
    ...
    public ResponseEntity<ListLostItemsResult> listLostItems(@Valid ListLostItemsHttpRequest request) {
        return ResponseEntity
                .status(200)
                .body(listLostItemsUseCase.execute(mapper.toListLostItemsCommand(request)));
    }
    ...
    public ResponseEntity<LostItemResult> updateLostItemStatus(
        ...
        return ResponseEntity
                .status(200)
                .body(updateLostItemStatusUseCase.execute(mapper.toUpdateLostItemStatusCommand(id, request)));
    }
}
